package ru.sapozhnikov.sensorschecker.processing.sensor.kafka_config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, SensorValue> consumerFactory() {
        ...
        config.put(
                ...
                "consuming");
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(SensorValue.class));
    }
